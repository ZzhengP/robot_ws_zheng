...
"""autogenerated by genpy from openpose_ros_msgs/GetPersonsRequest.msg. Do not edit."""
import sys
...
class GetPersonsRequest(genpy.Message):
  ...
  _type = "openpose_ros_msgs/GetPersonsRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from openpose_ros_msgs/GetPersonsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPersonsResponse(genpy.Message):
  _md5sum = "5c7fca3a20ea0f816b81a15333fcfc4b"
  _type = "openpose_ros_msgs/GetPersonsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['openpose_ros_msgs/PersonDetection[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.detections:
        _x = val1
        buff.write(_get_struct_2I().pack(_x.num_people_detected, _x.person_ID))
        _v1 = val1.nose
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.num_people_detected, _x.person_ID,) = _get_struct_2I().unpack(str[start:end])
        _v20 = val1.nose
        _x = _v20
        start = end
        end += 12
...
class GetPersons(object):
  _type          = 'openpose_ros_msgs/GetPersons'
  _md5sum = 'b372c9a3a4112a64a284d512401cc11f'
