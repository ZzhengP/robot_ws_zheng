...
"""autogenerated by genpy from kinect2_tracker/user_points.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import kinect2_tracker.msg
import geometry_msgs.msg
import std_msgs.msg

class user_points(genpy.Message):
  _md5sum = "6624cab0be89cfdee984fa8acaafad2a"
  _type = "kinect2_tracker/user_points"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Message storing the points of users.
# Header header
uint8[] users
...
geometry_msgs/PointStamped max"""
  __slots__ = ['users','people_points','boxes']
  _slot_types = ['uint8[]','geometry_msgs/PointStamped[]','kinect2_tracker/bounding_box[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(user_points, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.users is None:
        self.users = b''
      if self.people_points is None:
        self.people_points = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.people_points)
      buff.write(_struct_I.pack(length))
      for val1 in self.people_points:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.people_points.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.boxes = []
      for i in range(0, length):
        val1 = kinect2_tracker.msg.bounding_box()
        _v15 = val1.min
        _v16 = _v15.header
        start = end
        end += 4
