...
get_filename_component(_filename "/home/zheng/robot_ws_zheng/src/openni2_camera/openni2_camera/srv/GetSerial.srv" NAME_WE)
add_custom_target(_openni2_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "openni2_camera" "/home/zheng/robot_ws_zheng/src/openni2_camera/openni2_camera/srv/GetSerial.srv" ""
)
...
_generate_srv_cpp(openni2_camera
  "/home/zheng/robot_ws_zheng/src/openni2_camera/openni2_camera/srv/GetSerial.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/openni2_camera)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/openni2_camera\")")
  # install generated code
  install(
